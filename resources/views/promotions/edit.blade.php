                ...
                <div class="grid gap-4 grid-cols-3">
                    <div>
                        ...
                        <textarea name="desc1" rows="3" required name="desc1"
                                  class="w-full p-2.5 rounded-lg border bg-gray-50 text-gray-900 dark:bg-gray-600 dark:text-white">{{ $promotion->desc1 }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="desc2" rows="3" required name="desc2"
                                  class="w-full p-2.5 rounded-lg border bg-gray-50 text-gray-900 dark:bg-gray-600 dark:text-white">{{ $promotion->desc2 }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="desc3" rows="3" required name="desc3"
                                  class="w-full p-2.5 rounded-lg border bg-gray-50 text-gray-900 dark:bg-gray-600 dark:text-white">{{ $promotion->desc3 }}</textarea>
                    </div>
                </div>
